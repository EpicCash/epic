	...
	steps!(crate::EdnaWorld => {
		...
		then regex "I accept a block with a pow <([a-z0-9]+)> valid" |world, matches, _step| {
			...
			let proof = match proof_name {
				"progpow" => pow::Proof::ProgPowProof{
					mix: [
						160, 216, 239, 86, 103, 149, 207, 169, 20, 73, 222,
						81, 234, 177, 63, 153, 141, 79, 82, 115, 21, 95, 47,
						162, 150, 241, 1, 83, 233, 220, 164, 62],
				},
				"randomx" => pow::Proof::RandomXProof {
					hash: [
						81, 35, 154, 245, 157, 124, 207, 119, 188, 151, 166,
						168, 65, 9, 8, 174, 218, 232, 86, 240, 135, 89, 172,
						96, 113, 218, 88, 96, 109, 196, 114, 66],
				},
				"md5" => pow::Proof::MD5Proof {
					edge_bits: 10,
