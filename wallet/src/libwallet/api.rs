	...
	K: Keychain,
{
	...
	/// # Example
	/// ```
	/// # extern crate epic_wallet as wallet;
	...
	/// * `amount` - The amount to send, in nanoepics. (`1 G = 1_000_000_000nG`)
	/// * `minimum_confirmations` - The minimum number of confirmations an output
	...
	///		Some("Have some Epics. Love, Yeastplume".to_owned()),
	///	);
	///
	...
	/// Builds the complete transaction and sends it to a epic node for
	/// propagation.
