...
use epic_core::core::target::Difficulty;
use epic_core::core::{Block, BlockHeader, CompactBlock, Transaction};
use epic_core::libtx::build::{input, output, transaction, with_fee};
