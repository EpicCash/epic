...
mod mine_chain {
	...
	steps!(crate::EdnaWorld => {
		...
		then regex "I accept a block with a pow <([a-z0-9]+)> valid" |world, matches, _step| {
			...
			let proof = match proof_name {
				"progpow" => pow::Proof::ProgPowProof{
					mix: [6, 250, 255, 55, 21, 18, 233, 126, 46, 217,
						  149, 18, 120, 227, 172, 116, 192, 101, 142, 137,
						  99, 235, 204, 220, 159, 188, 164, 17, 244, 230, 56, 215],
				},
				"randomx" => pow::Proof::RandomXProof {
					hash: [21, 88, 167, 220, 245, 95, 176, 133, 1, 26,
						   226, 96, 254, 255, 40, 130, 131, 124, 130, 137,
						   220, 59, 99, 32, 69, 180, 40, 227, 36, 75, 141, 61],
				},
				"md5" => pow::Proof::MD5Proof {
					edge_bits: 10,
