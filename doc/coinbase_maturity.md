...
A Epic transaction consists of the following -
...
Epic does not permit duplicate commitments to exist in the Output set at the same time.
...
This is not necessarily recommended but Epic must handle this situation in a way that does not break consensus across the network.
...
Epic does not allow duplicate commitments to exist in the Output set simultaneously.
