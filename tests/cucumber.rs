...
mod mine_chain {
	...
	steps!(crate::EdnaWorld => {
		...
		then regex "I accept a block with a pow <([a-z0-9]+)> valid" |world, matches, _step| {
			...
			let proof = match proof_name {
				"progpow" => pow::Proof::ProgPowProof{
					mix: [9, 48, 1, 37, 74, 89, 92, 41, 226, 174, 138, 22, 39, 138, 245, 240, 7, 177, 241, 31, 29, 55, 252, 65, 213, 251, 77, 124, 205, 102, 126, 167],
				},
				"randomx" => pow::Proof::RandomXProof {
					hash: [200, 239, 166, 123, 89, 30, 172, 188, 34,214, 106, 232, 245, 71, 27, 22, 122, 198, 210, 205, 196, 50, 208, 107, 80, 8, 171, 22, 76, 84, 196, 204],
				},
				"md5" => pow::Proof::MD5Proof {
					edge_bits: 10,
