...
their 2 children. Epic uses the Blake2b hash function throughout, and always
...
In Epic, a lot of the data that gets hashed and stored in MMRs can eventually
