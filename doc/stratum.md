# Epic Stratum RPC Protocol

This document describes the current Stratum RPC protocol implemented in Epic.
...
Epic Stratum protocol implementation contains the following error message:
...
The current reference implementation is available at [mimblewimble/epic-miner](https://github.com/mimblewimble/epic-miner/blob/master/src/bin/client.rs).
