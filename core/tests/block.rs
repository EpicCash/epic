...
fn serialize_deserialize_header_version() {
	...
	ser::serialize(&mut vec1, &global::CURRENT_HEADER_VERSION).expect("serialization failed");
	...
	assert_eq!(version.0, global::CURRENT_HEADER_VERSION)
}
