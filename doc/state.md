...
The full state of a Epic chain consists of all the following data:
...
With a full Epic state, we can validate the following:
...
Data storage for outputs, range proofs and kernels in Epic is simple: a plain
