...
use epic_core::core::hash::DefaultHashable;
use epic_core::core::{Block, BlockHeader, KernelFeatures, Transaction};
use epic_core::libtx::{
...
use epic_core::ser::{self, FixedLength, PMMRable, Readable, Reader, Writeable, Writer};
	...
	B: ProofBuild,
{
	...
	let reward_output = reward::output(keychain, builder, &key_id, fees, false, height).unwrap();
	Block::new(
		&previous_header,
