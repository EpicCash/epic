...
A design goal of Epic is that all structures be as easy to implement and
...
are simple to specify (no scripts) and Epic is written in a language with
...
Epic itself does not need proof-of-spentness but it is a good thing to support
