	...
	steps!(crate::EdnaWorld => {
		...
		then regex "I accept a block with a pow <([a-z0-9]+)> valid" |world, matches, _step| {
			...
			let proof = match proof_name {
				"progpow" => pow::Proof::ProgPowProof{
					mix: [
						173, 238, 188, 117, 243, 151, 49, 27, 71, 216, 106,
						254, 100, 221, 223, 102, 203, 78, 253, 105, 156, 246,
						28, 143, 33, 214, 185, 50, 126, 58, 190, 223],
				},
				"randomx" => pow::Proof::RandomXProof {
					hash: [
						136, 160, 75, 227, 205, 230, 239, 225, 176, 190, 199,
						116, 235, 114, 142, 45, 127, 120, 134, 100, 27, 174, 242,
						121, 144, 87, 22, 102, 227, 245, 221, 64],
				},
				"md5" => pow::Proof::MD5Proof {
					edge_bits: 10,
